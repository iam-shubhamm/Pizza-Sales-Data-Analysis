...
📌 Project Summary
        ...
        The Pizza Sales Analysis Dashboard is a business intelligence project developed 
        using MS SQL Server and Power BI. It focuses on analyzing sales data to uncover
        meaningful insights related to revenue generation, customer behavior, and product performance.
...
📷 Dashboard Preview
        ...
        ⭐ Best & Worst Sellers
        <img width="1129" height="604" alt="image" src="https://github.com/user-attachments/assets/4f6955f0-72d4-4a56-842a-4a4fd6d4bb1c" />
